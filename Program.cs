...
namespace BotApp
{
    ...
    public class Program
    {
        ...
        private Task Client_Ready(ReadyEventArgs e)
        {
            ...
            e.Client.DebugLogger.LogMessage(LogLevel.Info, "Sinlyn's Task Bot", "Client is ready to process events.", DateTime.Now);
        ...
        private Task Client_GuildAvailable(GuildCreateEventArgs e)
        {
            ...
            // sent to our client
            e.Client.DebugLogger.LogMessage(LogLevel.Info, "Sinlyn's Task Bot", $"Guild available: {e.Guild.Name}", DateTime.Now);
        ...
        private Task Commands_CommandExecuted(CommandExecutionEventArgs e)
        {
            ...
            e.Context.Client.DebugLogger.LogMessage(LogLevel.Info, "Sinlyn's Task Bot", $"{e.Context.User.Username} successfully executed '{e.Command.QualifiedName}'", DateTime.Now);
        ...
        private async Task Commands_CommandErrored(CommandErrorEventArgs e)
        {
            ...
            e.Context.Client.DebugLogger.LogMessage(LogLevel.Error, "Sinlyn's Task Bot", $"{e.Context.User.Username} tried executing '{e.Command?.QualifiedName ?? "<unknown command>"}' but it errored: {e.Exception.GetType()}: {e.Exception.Message ?? "<no message>"}", DateTime.Now);
