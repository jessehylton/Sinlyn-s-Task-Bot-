...
namespace BotApp.Commands
{
    class Memes : BaseCommandModule
    {
        ...
        public class ExampleExecutableGroup
        {
            ...
            public async Task GroupMemeAsync(CommandContext ctx)
            {
            ...
            [Command("chili's"), Aliases("welcometo"), Description("Welcom to Chili's")]
            public async Task Chilis(CommandContext ctx)
            {
                await ctx.TriggerTypingAsync();
                await ctx.RespondAsync("Hi! Welcome to Chili's");
            }

            [Command("jazz"), Aliases("yalikejazz"), Description("For jazzy people")]
            public async Task Jazz(CommandContext ctx)
            {
                await ctx.TriggerTypingAsync();
                await ctx.RespondAsync("Ya like jazz?");
            }

            [Command("mlady"), Aliases("fedora"), Description("For the true gentleman")]
            public async Task Mlady(CommandContext ctx)
            {
                await ctx.TriggerTypingAsync();
                ...
                {
                    Title = "Hello M'Lady.",
                    ImageUrl = "https://i.imgur.com/FFuqfAE.gif"
                };
